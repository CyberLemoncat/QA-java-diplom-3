...
public class ConstructorTest extends BaseClass {
    ...
    @Description("Проверка что по кнопке Булочки страница пролистывается до заголовка Соусы")
    ...
    @Description("Проверка что по кнопке Булочки страница пролистывается до заголовка Начинки")
